                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                <div class="box box-primary">
                                    ...
                                    <form id="form_cliente" method="post" accept-charset="utf-8" class="form-horizontal" role="form">
                                        <div class="box-body">  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-lg-3">
                                                    <input type="text" class="form-control" name="data[Cliente][ci]" placeholder="Ingrese el RUC o CI del cliente" required=""/>
                                                </div>
                                            </div>  
                                            ...
                                            <div class="form-group fisica">
                                                ...
                                                <div class="col-md-6 col-sm-9 col-lg-7">
                                                    <input type="text" class="form-control" id="nombres" name="data[Cliente][nombres]" placeholder="Ingrese el nombre del cliente" required=""/>
                                                </div>
                                            </div>      
                                            <div class="form-group fisica">
                                                <label class="col-md-3 col-sm-3 col-lg-3 control-label">Apellidos:</label>
                                                <div class="col-md-6 col-sm-9 col-lg-7">
                                                    <input type="text" class="form-control" id="apellidos" name="data[Cliente][apellidos]" placeholder="Ingrese el apellido del cliente" required=""/>
                                                </div>
                                            </div>                                                                                             
                                            <div class="form-group juridica">
                                                <label class="col-md-3 col-sm-3 col-lg-3 control-label">Raz&oacute;n Social:</label>
                                                <div class="col-md-6 col-sm-9 col-lg-7">
                                                    <input type="text" class="form-control" id="razon" name="data[Cliente][razon]" placeholder="Ingrese el nombre de la empresa" required=""/>
                                                </div>
                                            </div>                                              
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-5 col-lg-3">                    
                                                    <select class="form-control select2" name="data[Cliente][residencia]">
                                            ...
                                            <div class="form-group fisica">
                                                ...
                                                <div class="col-md-3 col-sm-5 col-lg-3">                    
                                                    <select class="form-control select2" name="data[Cliente][nacionalidad]">
