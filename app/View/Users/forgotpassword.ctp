    ...
    <body>
        <div class="login-box">
            ...
            <div class="login-box-body">
                <form action="/sigest/users/forgotpassword" method="post">
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="Usuario" name="data[User][username]" autofocus="">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="email" class="form-control" placeholder="Correo" name="data[User][correo]">
                        <i class="fa fa-envelope form-control-feedback"></i>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <a href="/sigest/" class="btn btn-default">Cancelar</a>                            
                            <button type="submit" class="btn btn-primary pull-right">Recuperar</button>
                        </div>                        
                    </div>
                </form>
            </div><!-- /.login-box-body -->
